...
#import "WMSlidingTableViewController.h"
...
@interface WMSlidingTableViewController (PrivateStuff)
...
@implementation WMSlidingTableViewController
@synthesize activeTableView, sideSwipeView, sideSwipeCell, sideSwipeDirection, animatingSideSwipe;
...
- (void) setupGestureRecognizers
{
    ...
    [self.searchDisplayController.searchResultsTableView addGestureRecognizer:rightSwipeGestureRecognizer];
    ...
    [self.searchDisplayController.searchResultsTableView addGestureRecognizer:leftSwipeGestureRecognizer];
...
{
    self.activeTableView = self.searchDisplayController.isActive ? self.searchDisplayController.searchResultsTableView : self.tableView;
...
- (void)swipe:(UISwipeGestureRecognizer *)recognizer direction:(UISwipeGestureRecognizerDirection)direction
{
    if (recognizer && recognizer.state == UIGestureRecognizerStateEnded)
    {
        ...
        CGPoint location = [recognizer locationInView:activeTableView];
        NSIndexPath* indexPath = [activeTableView indexPathForRowAtPoint:location];
...
- (void) addSwipeViewTo:(UITableViewCell*)cell direction:(UISwipeGestureRecognizerDirection)direction
{
    ...
    [activeTableView insertSubview:sideSwipeView belowSubview:cell];
